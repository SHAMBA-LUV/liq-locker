// Vendored REFERENCE IMPLEMENTATION — tests only, never compiled into src/.
// OpenZeppelin Contracts v5.7.0, commit 0742777d7b30bdf178a5f64fa3b6cf341ba45ef9,
// contracts/utils/cryptography/ECDSA.sol, unmodified below this header.
// Vendored rather than submoduled so the repo keeps zero dependencies and so foundry
// never reads OpenZeppelin's own foundry.toml (it pins an evm_version this toolchain
// does not know). Used only by test/ecdsa_differential.t.sol as the thing to differ against.
